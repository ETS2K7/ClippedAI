...
const BUILT_IN_FONTS = [
  ...
  {
    name: "TikTokSans-SemiBold",
    display_name: "TikTok Sans SemiBold",
    format: "ttf",
  },
  {
    name: "TikTokSans-Medium",
    display_name: "TikTok Sans Medium",
    format: "ttf",
  },
  {
    name: "Montserrat-Regular",
    display_name: "Montserrat Regular",
    format: "ttf",
  },
  { name: "Montserrat-Bold", display_name: "Montserrat Bold", format: "ttf" },
  {
    name: "Montserrat-SemiBold",
    display_name: "Montserrat SemiBold",
    format: "ttf",
  },
  {
    name: "Montserrat-BoldItalic",
    display_name: "Montserrat Bold Italic",
    format: "ttf",
  },
  ...
  { name: "Roboto-Medium", display_name: "Roboto Medium", format: "ttf" },
  {
    ...
    display_name: "Open Sans Regular",
    format: "ttf",
  },
  { name: "OpenSans-Bold", display_name: "Open Sans Bold", format: "ttf" },
  {
    name: "OpenSans-SemiBold",
    display_name: "Open Sans SemiBold",
    format: "ttf",
  },
