  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white">
        ...
        <div className="mx-auto max-w-6xl px-4 py-16">
          <div className="mb-10 text-center">
            ...
            <p className="text-white/50">
              No subscription? Buy clips that never expire.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-2xl gap-4 sm:grid-cols-2">
            {CREDIT_PACKS.map((pack) => {
              ...
              return (
                ...
                >
                  {pack.badge && (
                    <span className="absolute -top-2.5 right-4 rounded-full bg-amber-500/20 border border-amber-500/40 px-3 py-0.5 text-xs font-semibold text-amber-400">
                      {pack.badge}
                    </span>
                  )}
                  <p className="mb-1 text-sm text-white/50">One-time purchase</p>
                  <h3 className="mb-1 text-2xl font-bold">{pack.name}</h3>
                  <p className="mb-4 text-white/40 text-sm">${pack.perClip} per clip</p>
      ...
      <div className="border-t border-white/[0.06] py-10 text-center text-sm text-white/30">
        <Link href="/dashboard" className="hover:text-white/60 transition-colors">← Back to dashboard</Link>
