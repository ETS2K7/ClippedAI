              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div className="brutal-card space-y-3 p-3 sm:p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      disabled={isLoading}
                    >
                      <SelectTrigger className="brutal-input h-11 w-full">
                        <SelectValue>
                ...
                >
                  <div className="brutal-card space-y-3 p-4">
                    ...
                    >
                      <div className="flex items-center gap-2 font-mono text-sm font-bold tracking-widest text-white uppercase transition-colors">
                        <Paintbrush className="h-4 w-4 text-white" />
                        FONT CUSTOMIZATION
                      </div>
                      <button
                        type="button"
                        className="font-mono text-[10px] font-bold tracking-widest text-white/30 uppercase transition-colors group-hover:text-white/60"
                      >
                    ...
                    {showAdvancedOptions && (
                      <div className="space-y-5 pt-1">
                        ...
                        <div className="space-y-2">
                          <label className="flex items-center gap-2 font-mono text-[10px] font-bold tracking-widest text-white/50 uppercase">
                            <Type className="h-3.5 w-3.5" />
                            FONT FAMILY
                          </label>
                          <div className="flex items-center justify-between gap-3 font-mono text-xs tracking-wider text-white/30 uppercase">
                            <span>
                              {availableFonts.length} font
                              {availableFonts.length === 1 ? "" : "s"} available
                            </span>
                            <input
                            ...
                            <Button
                              ...
                              className="border-white/10 text-white/50 hover:bg-white/[0.06] hover:text-white"
                            >
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <Input
                                ...
                                disabled={isLoading}
                                placeholder="#FFFFFF"
                                className="brutal-input h-8 flex-1 font-mono text-xs"
                                pattern="^#[0-9A-Fa-f]{6}$"
                              />
                            </div>
                            <div className="mt-1 flex gap-1.5">
                              {[
                                ...
                                <button
                                  ...
                                  className="h-5 w-5 cursor-pointer rounded-full border-2 border-white/10 transition-all hover:scale-125 hover:border-white/30 disabled:cursor-not-allowed"
